...
/*class CloudKitSyncLoaderTests: XCTestCase {
	...
	static var allTests = [
		...
		("testLoadShareFailAccept", testLoadShareFailAccept),
		("testLoadShareFailFetchList", testLoadShareFailFetchList),
		("testLoadShareFailFetchItems", testLoadShareFailFetchItems),
		("testFetchChangesLocal", testFetchChangesLocal),
		("testFetchChangesLocalFailOnDb", testFetchChangesLocalFailOnDb),
		("testFetchChangesLocalFailOnZone", testFetchChangesLocalFailOnZone),
		("testFetchChangesRemote", testFetchChangesRemote)
    ]
